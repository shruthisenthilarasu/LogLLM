"""
FastAPI Web Demo for LogLLM
A simple web interface for log classification
"""
...
def load_model():
    ...
    # For Hugging Face Spaces, model might be in different location
    ...
    if not os.path.exists(model_path):
        ...
        print("Using a placeholder. Please train the model first.")
        return None
